...
int main() {
	...
	TextContainer rectangle_text {"Rectangle", Color::create(1, 1, 1, 0.9), 250, 150};
	...
	TextContainer rounded_rectangle_text {"RoundedRectangle", Color::create(1, 1, 1, 0.9), 250, 150};
